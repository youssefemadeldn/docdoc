...
class _RestClient implements RestClient {
  ...
  Future<SingUpResponseModel> signUp(
      SingUpRequestBodyModel singUpRequestBodyModel) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(singUpRequestBodyModel.toJson());
    final _options = _setStreamType<SingUpResponseModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SingUpResponseModel _value;
    try {
      _value = SingUpResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
